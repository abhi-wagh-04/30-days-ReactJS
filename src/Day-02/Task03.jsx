  ...
  return (
    <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', margin:0}}>
        <div style={{display: 'flex', flexDirection: 'column'}}>
            <textarea  value={char}  onChange={(e) => {if(e.target.value.length <= 250)  setChar(e.target.value)}} rows="6" cols="50" placeholder='Enter your text here' style={{ fontSize: "20px",padding:"10px", width:"600px", height:"180px"}}/>
